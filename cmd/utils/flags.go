...
import (
	...
	"github.com/kaleidochain/kaleido/common/fdlimit"
	...
	"github.com/kaleidochain/kaleido/consensus/clique"
	...
	"github.com/kaleidochain/kaleido/dashboard"
	"github.com/kaleidochain/kaleido/eth"
	"github.com/kaleidochain/kaleido/eth/downloader"
	"github.com/kaleidochain/kaleido/eth/gasprice"
	...
	"github.com/kaleidochain/kaleido/p2p/netutil"
	"github.com/kaleidochain/kaleido/params"
	whisper "github.com/kaleidochain/kaleido/whisper/whisperv6"
...
func setBootstrapNodes(ctx *cli.Context, cfg *p2p.Config) {
	urls := params.KaleidoMainnetBootnodes
	switch {
	...
	case ctx.GlobalBool(TestnetFlag.Name):
		urls = params.KaleidoTestnetBootnodes
...
func setBootstrapNodesV5(ctx *cli.Context, cfg *p2p.Config) {
	urls := params.KaleidoMainnetBootnodesV5
	switch {
	...
	case ctx.GlobalBool(TestnetFlag.Name):
		urls = params.KaleidoTestnetBootnodesV5
	case ctx.GlobalBool(RinkebyFlag.Name):
		urls = params.RinkebyBootnodes
	case ctx.GlobalBool(GoerliFlag.Name):
		urls = params.GoerliBootnodes
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	switch {
	case ctx.GlobalBool(TestnetFlag.Name):
		cfg.Genesis = core.DefaultKaleidoTestnetGenesisBlock()
		if !ctx.GlobalIsSet(NetworkIdFlag.Name) {

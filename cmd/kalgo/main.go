...
// kalgo is the official command-line client for Kaleido.
package main
...
import (
	...
	"github.com/kaleidochain/kaleido/internal/debug"
	"github.com/kaleidochain/kaleido/node"
	cli "gopkg.in/urfave/cli.v1"
)

const (
	clientIdentifier = "kalgo" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the kaleidochain command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2018-2019 The kaleidochain Authors"
...
// kalgo is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func kalgo(ctx *cli.Context) error {

...
// Tests that initializing Kalgo with a custom genesis block and chain definitions
// work properly.
func TestCustomGenesis(t *testing.T) {
	for i, tt := range customGenesisTests {
		...
		runKalgo(t, "--datadir", datadir, "init", json).WaitExit()

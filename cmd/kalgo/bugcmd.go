...
import (
	...
	"github.com/kaleidochain/kaleido/cmd/internal/browser"
...
var bugCommand = cli.Command{
	...
	Name:      "bug",
	Usage:     "opens a window to report a bug on the kalgo repo",
	ArgsUsage: " ",
	Category:  "MISCELLANEOUS COMMANDS",
}

const issueURL = "https://github.com/kaleidochain/kaleido/issues/new"
...
func reportBug(ctx *cli.Context) error {
	...
	fmt.Fprintln(&buff)
	fmt.Fprintln(&buff, "Version:", params.KalgoVersionWithMeta)

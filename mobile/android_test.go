...
public class AndroidTest extends InstrumentationTestCase {
	...
	// signatures too. Regression test for kaleido issue #14599.
...
func TestAndroid(t *testing.T) {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "io.kaleidochain", "github.com/kaleidochain/kaleido/mobile")

...
func SetupGenesisBlockWithOverride(db ethdb.Database, genesis *Genesis, constantinopleOverride *big.Int) (*params.ChainConfig, common.Hash, error) {
	...
	if (stored == common.Hash{}) {
		if genesis == nil {
			...
			genesis = DefaultKaleidoGenesisBlock()
		} else {
...
// DefaultKaleidoGenesisBlock returns the Kaleido main net genesis block.
func DefaultKaleidoGenesisBlock() *Genesis {
	return &Genesis{
		Config:               params.KaleidoMainnetChainConfig,
		Nonce:                params.ConsensusVersion,
		Timestamp:            1561878357,
		ExtraData:            hexutil.MustDecode("0x6b616c6569646f"),
		GasLimit:             63000000,
		Difficulty:           big.NewInt(0),
		TotalBalanceOfMiners: kaleidoMainnetGenesisBalance,
		Seed:                 hexutil.MustDecode("0x21bdecb9be97141771ff677cff15f34c8b97be9a94a7b26448a308e4a9f1d648"),
		Alloc:                kaleidoMainnetAllocData,
	}
}

// DefaultKaleidoTestnetGenesisBlock returns the Kaleido test net genesis block.
func DefaultKaleidoTestnetGenesisBlock() *Genesis {
	return &Genesis{
		Config:               params.KaleidoTestnetChainConfig,
		Nonce:                params.ConsensusVersion,
		Timestamp:            1561544891,
		ExtraData:            hexutil.MustDecode("0x6b616c6569646f"),
		GasLimit:             63000000,
		Difficulty:           big.NewInt(0),
		TotalBalanceOfMiners: kaleidoTestnetGenesisBalance,
		Seed:                 hexutil.MustDecode("0x3b2cf2c1df1773338a3b8f3a94c843a3b2b38a02b1683ff4bbe4b94dfdf553a1"),
		Alloc:                kaleidoTestnetAllocData,
	}
}

// DefaultKaleidoDevnetGenesisBlock returns the Kaleido dev net genesis block.
func DefaultKaleidoDevnetGenesisBlock() *Genesis {
	return &Genesis{
		Config:               params.KaleidoDevnetChainConfig,
		Nonce:                params.ConsensusVersion,
		ExtraData:            hexutil.MustDecode("0x6b616c6569646f"),
		GasLimit:             63000000,
		Difficulty:           big.NewInt(0),
